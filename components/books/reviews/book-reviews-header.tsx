...
const BookReviewsHeader = ({ reviews }: { reviews: number | undefined }) => {
  return (
    <div className="flex justify-between items-center mb-6" id="reviews">
      ...
      <div className="px-3 py-1 text-xs font-medium bg-gray-100 rounded-full dark:bg-secondary">
        <span className="font-bold">{reviews || 0}</span>{" "}
