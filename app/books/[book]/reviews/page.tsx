...
const Page = () => {
  ...
  const { bookReviews, isLoading, error, pagination, handlePaginationChange } = useBookReviews({
    bookId: params.book,
    initialLimit: 3,
    initialPage: 1,
      ...
      <div className="min-h-[calc(100vh-55px)] w-full flex items-center justify-center bg-neutral-50 dark:bg-neutral-950">
        <div className="text-center space-y-4">
          ...
          <div className="flex items-center gap-2 justify-center">
            ...
            <span className="text-lg font-medium text-neutral-700 dark:text-neutral-300">Loading book reviews...</span>
          </div>
        </div>
      </div>
    )
    ...
    return (
      <div className="min-h-[calc(100vh-55px)] w-full flex items-center justify-center bg-neutral-50 dark:bg-neutral-950">
        <div className="text-center space-y-4">
          ...
          <h2 className="text-lg font-medium text-neutral-700 dark:text-neutral-300">Oops! Something went wrong</h2>
