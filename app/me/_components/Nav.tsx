...
const Nav = () => {
  return (
    <div className="flex items-center gap-2 fixed z-50 bg-neutral-100 dark:bg-zinc-950  border border-zinc-300 dark:border-zinc-800 p-2 rounded-full top-5 inset-x-0 m-auto w-fit  transition-[width,colors_0.35s_cubic-bezier(0.68,-0.55,0.27,1.55)]">
      ...
      >
        {/* <Review */}
        <Image src="/review.jpg" width="20" height="20" className="rounded-sm" alt="review icon"/>
        <span className="px-1 font-medium ">Reviews</span>
      </Link>
    </div>
  );
};
